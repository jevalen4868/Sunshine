package com.fallenman.jeremyvalenzuela.sunshine.app.sync;
...
import com.fallenman.jeremyvalenzuela.sunshine.app.MainActivity;
import com.fallenman.jeremyvalenzuela.sunshine.app.R;
...
import com.fallenman.jeremyvalenzuela.sunshine.app.muzei.WeatherMuzeiSource;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private static void setLocationStatus(Context c, @LocationStatus int status) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(c);
        SharedPreferences.Editor editor = prefs.edit();
        String locationStatusKey = c.getString(R.string.pref_location_status_key);
        editor.putInt(locationStatusKey, status);
        editor.commit();
    }

    @Override
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        Log.d(LOG_TAG, "onPerformSync Called. " + System.currentTimeMillis());
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        if (cVVector.size() > 0) {
            ...
            long deleted = getContext().getContentResolver().delete(
    ...
    private void notifyWeather() {
        ...
        if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
            ...
            if (cursor.moveToFirst()) {
                ...
                // Construct intent to pass to notification.
                Intent weatherIntent = new Intent(context, MainActivity.class);
                // Construct task stack builder so that android knows what to back out to.
